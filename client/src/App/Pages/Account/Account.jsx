    ...
    <Flex minH={'100vh'} align={'center'} justify={'center'} bg='radial-gradient(ellipse at bottom, #0d1d31 0%, #0c0d13 100%)'>
      <Stack className='pepe' spacing={6} w={'full'} maxW={'md'} bg={'transparent'} rounded={'xl'} boxShadow={'lg'} p={6} >
        ...
        <FormControl id="email">
          ...
          <Input focusBorderColor='#f2a900' placeholder="yourbestemail@example.com" _placeholder={{ color: 'gray.500' }} type="email" />
        </FormControl>
        <FormControl id="email">
          <FormLabel color={'white'} fontFamily='GilroySemiBold'>Message price in sats</FormLabel>
          <Input focusBorderColor='#f2a900' placeholder="1000" _placeholder={{ color: 'gray.500' }} type="number" />
        ...
        <Stack spacing={6} direction={['column', 'row']}>
          ...
          <Button backgroundColor='#f2a900' color='white' textShadow='0px 0px 10px #00000080' _hover={{ bg: '#f2a900' }} fontFamily='GilroySemiBold' w="full" >Save</Button>
        </Stack>
      </Stack>
    </Flex>
  );
